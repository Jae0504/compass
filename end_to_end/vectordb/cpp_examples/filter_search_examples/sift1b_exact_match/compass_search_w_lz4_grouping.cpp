...
Args parse_args(int argc, char** argv) {
    ...
    // sift1b_exact_match: always uint8 (bvecs)
...
int main(int argc, char** argv) {
    try {
        ...
        const size_t query_elem_bytes = sizeof(uint8_t);
        const std::string index_vector_type = "bvecs";
        ...
        RunStats stats = run_search_typed<int, hnswlib::L2SpaceI, uint8_t>(
            args,
